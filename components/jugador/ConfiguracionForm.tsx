        ...
        <>
            ...
            <div className="bg-dark-card p-6 rounded-lg space-y-4">
                ...
                <form action={handleLinkCoach} className="flex gap-2">
                    ...
                    <button type="submit" className="bg-brand-green font-semibold px-4 rounded-lg">Vincular</button>
                </form>
            </div>
            ...
            <div className="bg-dark-card p-6 rounded-lg space-y-4">
                ...
                <form action={signOut}>
                    <button type="submit" className="w-full bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded-lg">
                        Cerrar Sesión
                    </button>
                </form>
            </div>
